...
# Harden msiserver - Used for Vault upgrde scenarios where re-hardening of the service is needed:
...
if($ProductName.Contains(2019) -or $ProductName.Contains(2022)) {
	"Adding Windows Updates hardening registry entries"
	""
	New-ItemProperty -Path $RegistryPath -Name DeferFeatureUpdates -PropertyType DWORD -Value 1 | out-null
	New-ItemProperty -Path $RegistryPath -Name BranchReadinessLevel -PropertyType DWORD -Value 20 | out-null
	New-ItemProperty -Path $RegistryPath -Name DeferFeatureUpdatesPeriodInDays -PropertyType DWORD -Value 180 | out-null
	New-ItemProperty -Path $RegistryPath -Name PauseFeatureUpdatesStartTime -PropertyType STRING -Value "" | out-null
	New-ItemProperty -Path $RegistryPath -Name DeferQualityUpdates -PropertyType DWORD -Value 1 | out-null
	New-ItemProperty -Path $RegistryPath -Name DeferQualityUpdatesPeriodInDays -PropertyType DWORD -Value 0 | out-null
	New-ItemProperty -Path $RegistryPath -Name PauseQualityUpdatesStartTime -PropertyType STRING -Value "" | out-null
	New-ItemProperty -Path $RegistryPath -Name ManagePreviewBuilds -PropertyType DWORD -Value 1 | out-null
	New-ItemProperty -Path $RegistryPath -Name ManagePreviewBuildsPolicyValue -PropertyType DWORD -Value 0 | out-null
}
...
""
"*** Finished closing services ***"

# SIG # Begin signature block
# MIIqRQYJKoZIhvcNAQcCoIIqNjCCKjICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBmFj3xx3PVQ+1g
# aIgS21fGO+C/9gbErGjP+K33uHsX4KCCGFcwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQkEMSIEINavtnMb7QhNTQJpYTQgrjCsoHtJKdBD3jCieAhbJTIQMA0GCSqGSIb3
# DQEBAQUABIICAFn9+Hphv7/bJWfgXwP7GJSWJwLp+XVvH46fsD+Ph+vfw+0OUajG
# tecV5K3lh59zsNVcAGPPxB1mzXfLZOHkoOX1QLl9DkcCC8tzUQY26itYYLamMNKi
# v5CS304QQ8koOy8xlE3kq7qaS66FEqgakaJEuT1A49s3XR3/ye4SEjaNislkc032
# xbHjuJJequLM0ege3dMbWhCgyZmFk6hQih+rClGybcv7g5rZOjXVfH4lqlXp8Lu+
# HGahPt//9ks33fxrMZbTs5GvIVoJM+6IP1oLom5SyMb0Uc0VJI4OvLQ9peu7PgbS
# WRAmeMpG1f2nBWMtnPKYEn5Be7DqVpXVCyanay8jFa1OKYQPv159j7vW/4Ulmi0o
# ZUuXbYSLbO/9h5KLInrAasd4ix511Axny7tg7E9iD1rN/G4lPOD7LwNQffUWTAn4
# tUVCpZTbbxuNadbxzfNi+O+n0aC8oKtmO13ChHthlIuNieYjImyKVQY6JqZK19RG
# OJT+xqS8J6zdcJ3cBY6zIMAdgJaAKCGBQu0sY4R1Nv5pKtqKoV9Yz7SanTr2ouuo
# rObimSTebiV50wYR/ttQQcU6Q4wN72/jRJAK6ceCOPpTNqRr71xRFiT58xZRSX3P
# /ilnmLEZwl2WjOo2ffaG8jHGc8LfhsCguTLXevFhtYclXsC/wz2KNkReoYIOKzCC
...
# AQcXAzAhMAkGBSsOAwIaBQAEFHYEyG8ZJj3fxB/WEkf5L4dkagFbAhQB6ZE659Q3
# YU3E98STjIcIqqZaXhgPMjAyNDA1MTYwOTE2MDdaMAMCAR6ggYakgYMwgYAxCzAJ
...
# MBwGCSqGSIb3DQEJBTEPFw0yNDA1MTYwOTE2MDdaMC8GCSqGSIb3DQEJBDEiBCBG
# StwOyPnk00SUbm+M1P6x8YREYxl2Ws1sTEBSwUquzjA3BgsqhkiG9w0BCRACLzEo
# MCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG
# 9w0BAQEEggEAX6cBOGDHaXarV/8Am8SVO5Yt9UVxnkSBgpjaLV99P6uih5pQBAje
# MVMU3N+vb/8O8ADWWTFZcypCoySA5eOyL44f+nKZeWvhHBcwkFjRoXoKacuPQG4p
# 7dElUnQT1nxIC21hikCd4jjFYT7v5dddJWyLl+Guk7VHtCc512WH+YFXEaa7jc1u
# NUVHPPb9j/fCYMn6mUQ46HqW6xomdYcbpcXlSfkpZrvaxVbLpnQsicQE6dLYFRFh
# PmlRtk9Nmnmh0g3MvMunfICImr5fk9w64XmTa8urGeAKGftPqsVYfD3EiVgvANvu
# N/NId0DRUncoTTwVd5iIAdsNLtoisgDlxA==
