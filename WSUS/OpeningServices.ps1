...
# UnHarden msiserver - Used for Vault upgrde scenarios where re-hardening of the service is needed:
...
if($ProductName.Contains(2019) -or $ProductName.Contains(2022)) {
	"Disabling Windows Updates hardening registry entries"
	""
	Remove-ItemProperty -Path $RegistryPath -Name DeferFeatureUpdates 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name BranchReadinessLevel 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name DeferFeatureUpdatesPeriodInDays 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name PauseFeatureUpdatesStartTime 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name DeferQualityUpdates 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name DeferQualityUpdatesPeriodInDays 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name PauseQualityUpdatesStartTime 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name ManagePreviewBuilds 2>$null
	Remove-ItemProperty -Path $RegistryPath -Name ManagePreviewBuildsPolicyValue 2>$null

}
"Windows Update services are enabled"
""
"*** Finished opening services ***"

# SIG # Begin signature block
# MIIqRQYJKoZIhvcNAQcCoIIqNjCCKjICAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCACjQ62UQDp+sGm
# PZQalWlzYMcjbF2yzF53uXwviL9JeqCCGFcwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQkEMSIEID4mnPbiVFz75h6gECTJiPiMHgKLW+BVsnIs5qiR2u9AMA0GCSqGSIb3
# DQEBAQUABIICAE8FmdZ+19ushDSlCG+/xcbCvvpPXux8TNIU1APhYrH0xxcCA0u/
# upRXRjSOaYzeku6PRXhFtpt1opeKipA19r00gZQbiHd5bBFERoTVRDFBA9HJoBxN
# AXW2URIS91SF56Q2qm/qOxvNjkC86R65O0XjzBB+aVpKuWetRvUUZowp2VmkbxT4
# OKtdMhfx/5RfjO2gLCneJm4RwF5XfrRh1TjeYM9vyigqegBpbygmaIRp8ZWgmT/+
# 8W8/EOSFxswo9oaz20upJvYvKuriFX/kAvQ4NH7Pplj55EUIVTXGg6rNGRDT0v1L
# SvxZuwABIh/fYBOZL0wZ92dqWPdi6pKQVCRcvYHgl5lyHdT6tqO+RlPUIOh9yRAQ
# P1Knu2rfVWJ+9gn8s5mawzyLdoyoWbqyf3qyn7Y8k7b+IIHLxoydo2AKPDsn+Aur
# giZbu5KOu43rRjvVqsCjv2eVtUi3ZCTAB7dykQwHxP8WPAMUZrGSJD1eUB0wTmTi
# 1Jm973ufy1W9oV5G3K0dB8IuTkxQNH8FjVHeVKpNw6Jc5ds1Of3A/uqvOatEbYDq
# X+mjjVbPnlshH418e0fF78fuPSQjMN6cjsNCDGwiTHMUOm+lLhg1MFIZu5ii8la5
# ONNLOlwFjdoHzAYe/z7rT3AoS859UuEcQmIofUI5W1V+67QOlzJjm7OAoYIOKzCC
...
# AQcXAzAhMAkGBSsOAwIaBQAEFF2hq4O7Of1+jb4J5mmUGWtqri6zAhRRhmoDvlIj
# iygCmNjT9D415IuDXBgPMjAyNDA1MTYwOTE2MDRaMAMCAR6ggYakgYMwgYAxCzAJ
...
# MBwGCSqGSIb3DQEJBTEPFw0yNDA1MTYwOTE2MDRaMC8GCSqGSIb3DQEJBDEiBCBi
# mMdoX1JcAyODFxxGkDCxYsZjfTX2oBYiqKhGJrOIrDA3BgsqhkiG9w0BCRACLzEo
# MCYwJDAiBCDEdM52AH0COU4NpeTefBTGgPniggE8/vZT7123H99h+DALBgkqhkiG
# 9w0BAQEEggEAaDG36fF2BGz26JebdymEdGOHsqHjkEURXW4Ufq1ptZTPiy++s+U9
# WXNOqliqb6CQBXnZzZoaTzmC4YE2xVum0n1sEhfqSl/IN/qTyG+9Qoykc/4tlCMw
# uB/WrhX3O2Un3CsqsTJ30uymnNTFgMG3a1gOfZllalF9tr3l6O5v0HredVf/RsPt
# wbdeU0oT+2Hs0bdRBsB8NVNbAo/M9jSwsb04nitS865XzAcpL+J18Vjt3LqzLXPw
# dBKYP/tkDNl2eNKRD5qmSDL8mEFNbi1O7RxeXZ+F2Ps0bIoIBwlMKcENP9kZqrrB
# 7YO+H1gj25gz1yy6ZGt98CRsftMU712qVQ==
