"*** Configure the WSUS server integration ***"
...
Try
{
    ...
    {
        "Error: the WSUS URL parameter is missing"
        return
    }
    ...
    New-ItemProperty -Path $WsusRegistryPath -Name $UpdateServiceUrlAlternate -Value $WSUSServer -PropertyType String -Force | Out-Null
    ...
    "WSUS was integrated succesfully"
}
Catch 
{
    "Error: Failed to complete the WSUS server integration."
    return
}

""
"*** Finished the WSUS server integration process ***"

# SIG # Begin signature block
# MIIqRgYJKoZIhvcNAQcCoIIqNzCCKjMCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBBlEP5KrHBZWtp
# MNlk1LsgeHZerYnt8zodnWTWk7KD+KCCGFcwggROMIIDNqADAgECAg0B7l8Wnf+X
...
# AQkEMSIEIPmQBqaedttYP60lKwjmuCqpGKpHrLcIY0CTKcKoht5qMA0GCSqGSIb3
# DQEBAQUABIICABE4rWV0bA7OFeBJ9W40kwVFbhgdacfKYFMjsTIerZ9ZXGHVpR9p
# J+bXFizUSiJ1qmEV2nrpM+bMoJMFutKIAXjAllg17ZsVnZuJXAXq9Ah1DkdPC8xN
# s2J4vi6jBTWPsh+Q61O63lgO13kH9qKm+kW5Jilg2Fmz1uupjka5nX+sRefAYmkA
# qCghDPb4OdW/wWW3Od8QlLTWbI7NWJ6gt3WHYY7cnY8j8omsLpDBoWIjW1dSxOTa
# xZtVgnsxfPPKNnQGXqnqdKQKeCOpd5Ba97BQxa6DtqXhKcBaSZYTyqoIwO33Zz/y
# QRjxtunWHaqPUAaGBmPcwruZzAl/gSTzWvfKtbQk1lwmvka5r7x/e95td/1gKrAE
# 6ap4/TBUtBBqwd4HJvzNTVOgomCmOLViOnvKdXVrkVqXFuzRUAsJdFigjxw+RReH
# 5g5bjptDpj9KPR/zLFnHWPEoVfkV5n9uNClVyNc4hIKvgwBSR1s7DXEinNQoT/6F
# HGlkBiJ4zxNyCFIPSMq7/JeuzSmY5yVxUuLHgCZQn/XXSMRCt8ZEdbSjMzVLJYeO
# ps3qsPU4PUJ0tTthumJ5e1r15b0YpsdxgY0w/gHfPCoRmHdeqw07dQvB4M+4iTQc
# GiPfvC6ZwSDYZTfITVvowagan1lIVpPDTfF6Q3rE7KJ0uIM82oo/kd8woYIOLDCC
...
# AQcXAzAhMAkGBSsOAwIaBQAEFOH65ByY4S3RlCQe00Wck63yFQU0AhUAq8EOGrsV
# 0KPugUFVeRUyFq0DGjgYDzIwMjQwNTE2MDkxNjAxWjADAgEeoIGGpIGDMIGAMQsw
...
# BDAcBgkqhkiG9w0BCQUxDxcNMjQwNTE2MDkxNjAxWjAvBgkqhkiG9w0BCQQxIgQg
# Zh8hfgy79zwfDe2j9FQFLkGsLT1FPjXStT6Uj1Nmq9kwNwYLKoZIhvcNAQkQAi8x
# KDAmMCQwIgQgxHTOdgB9AjlODaXk3nwUxoD54oIBPP72U+9dtx/fYfgwCwYJKoZI
# hvcNAQEBBIIBAJKleP62lAkOdjibLPmFB4e3bm2cNL7EC4tCihWi/4b3geIV6swE
# B7b5WWdUM7DcfeEaA+j7SQNggOt1JWwnG+1S4/vEcjpOiLPFnCfDtFxRQPiaqBGK
# aXex5YhoIkZrJv1l2Ei1meGST9bMG5MHa0FZHZ+/IxgV1mGAwW7cYR/4eHaFKNu1
# 4LvpHUo7xnWYGzTifB7LN36ILtAa37xBQze691VHGfbSaZT0cuZccG+9r59D4a41
# c1FGMrJJBKOREeGk3LYcbdxDbERQN927qQiboQz9L+FvMXjkZKzM23PArmDjUcs7
# Y58wS9qNXCH4nJU59zGq+Dp54Ilpg9lqeJk=
